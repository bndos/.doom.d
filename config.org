...
(setq! doom-font (font-spec :family "Comic Shanns" :weight 'normal :size 27)
       doom-variable-pitch-font (font-spec :family "Comic Shanns" :weight 'bold :size 27)
       doom-big-font (font-spec :family "Comic Shanns" :weight 'bold :size 50))
