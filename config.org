...
(custom-set-faces!
  ...
  '(magit-section-highlight :background "#17111f" :extend t :inverse-video nil)
  '(magit-diff-hunk-region :foreground unspecified :background unspecified :weight bold :underline (:color "#ff79c6" :style line) :inverse-video nil :box nil :extend t)
