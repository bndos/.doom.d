...
(setq! doom-font (font-spec :family "Monego" :slant 'normal :weight 'bold :size 20)
       doom-variable-pitch-font (font-spec :family "Monego" :slant 'normal :weight 'bold :size 20)
