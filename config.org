...
(use-package! lsp-bridge
  ...
  (setq lsp-bridge-diagnostic-max-number 10)
  ...
  (setq lsp-bridge-semantic-tokens-mode nil)
  ...
  (map! :map lsp-bridge-mode-map
        ...
        :leader "c f" #'lsp-bridge-code-format
        )
  ...
  (defun lsp-bridge-diagnostic-hide-overlays ()
    ...
    (setq-local lsp-bridge-diagnostic-overlays '())))
#+END_SRC
