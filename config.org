...
(setq! doom-font (font-spec :family "Monego" :style "Bold" :size 26)
       doom-variable-pitch-font (font-spec :family "Monego" :style "Bold" :size 26)
       doom-big-font (font-spec :family "Monego" :style "Bold" :size 29))
(setq! doom-unicode-font (font-spec :family "MesloLGS NF" :size 26))
...
(custom-set-faces!
  ...
  '(ein:basecell-input-area-face :background "#0a0a0a")
  ...
  '(mode-line-inactive :background nil :box nil)
  '(powerline-active0 :background "#202020")
  '(powerline-active1 :background "#202020")
  '(powerline-active2 :background "#050505")
  '(powerline-inactive0 :background nil)
  '(powerline-inactive1 :background nil)
...
;; window-rules
(defvar parameters
  '(window-parameters . ((window-dedicated-p . t) (no-delete-other-windows . t) (unsplittable . t) (no-other-window . nil)))
  )
...
(setq
 ...
 `(("\\*Buffer List\\*" display-buffer-in-side-window
   ...
   ("\\*\\(?:Tag List\\|Python\\)\\*\\|^*julia" display-buffer-in-side-window
   ...
   ("^magit:" display-buffer-in-side-window
    ...
    (preserve-size . (t . nil)) ,parameters)
   ("\\*\\(?:help\\|grep\\|Completions\\)\\*\\|^*compilation\\|^*Flutter\\|^*pytest\\|^*docker-build-output\\|^*ein\\|^*MATLAB\\|^* docker container"
