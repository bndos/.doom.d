...
(setq! doom-font (font-spec :family "Comic Shanns" :weight 'normal :size 26)
       doom-variable-pitch-font (font-spec :family "Comic Shanns" :weight 'normal :size 26)
       doom-big-font (font-spec :family "Comic Shanns" :weight 'normal :size 50))
...
(add-to-list 'default-frame-alist
             '(font . "Comic Shanns-14"))


(add-to-list 'default-frame-alist '(internal-border-width . 20))
(add-to-list 'default-frame-alist '(alpha-background . 97))

(set-frame-parameter (selected-frame) 'alpha-background 0.97)
