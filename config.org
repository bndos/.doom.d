...
(setq! doom-font (font-spec :family "Monego" :slant 'normal :weight 'bold :size 20)
       ...
       doom-big-font (font-spec :family "Monego" :slant 'normal :weight 'bold :size 28))
(setq! doom-unicode-font (font-spec :family "MesloLGS NF" :slant 'normal :weight 'bold :size 20))
