...
(setq fancy-splash-image "~/.doom.d/gnu-head.png")
...
(setq doom-font (font-spec :family "Consolas NF" :style "Bold" :size 17)
      doom-variable-pitch-font (font-spec :family "Consolas NF" :style "Bold" :size 17)
