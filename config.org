...
(setq! doom-font (font-spec :family "Monaco" :weight 'normal :size 14)
       doom-variable-pitch-font (font-spec :family "Comic Mono" :weight 'normal :size 14)
       doom-big-font (font-spec :family "Monaco" :weight 'normal :size 42))
...
(custom-set-faces!
  ...
  '(xref-match :foreground "#000000" :background "#8be9fd")
