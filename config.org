...
(add-hook 'eglot-managed-mode-hook
          (lambda ()
            (when (derived-mode-p 'python-mode)
              ...
              (setq my/flycheck-local-cache '((eglot-check . ((next-checkers . (python-ruff)))))))))
...
(setq
 ...
 `(
   ...
   ("\\*\\(?:help\\|grep\\|Completions\\|org-python-session\\|Python\\)\\*\\|^*leetcode\\|^*compilation\\|^*Flutter\\|^*pytest\\|^*docker-build-output\\|^*ein\\|^*MATLAB\\|^* docker container" display-buffer-in-side-window
    (side . top) (slot . 3) (preserve-size . (t . nil)) (window-height . 0.15) (dedicated . t))

   ("\\*\\(?:shell\\|vterm\\)\\*" display-buffer-in-side-window
    (side . top) (slot . 4) (preserve-size . (nil . t)) (window-height . 0.15) (dedicated . t))
