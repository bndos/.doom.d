;; this seems to work fine for go and python since lsp proxy does not work well with venvs:
* Appearance
...
(use-package eglot
  ...
  (map! :map eglot-mode-map
        ...
        ;; :leader "c r" #'eglot-rename
        ;; :leader "c a" #'eglot-execute-code-action
        ;; :leader "c d" #'eglot-describe-thing-at-point
