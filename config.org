...
(setq! doom-font (font-spec :family "Comic Mono" :weight 'normal :size 26)
       doom-variable-pitch-font (font-spec :family "Comic Mono" :weight 'normal :size 26)
...
(use-package! lsp-bridge
  ...
  (setq lsp-bridge-flash-region-delay 2)
  (setq lsp-bridge-enable-completion-in-string t)
  (setq lsp-bridge-enable-hover-diagnostic t)


  (setq lsp-bridge-completion-in-string-file-types '("dart" "python"))
  ;; add evil keys to lsp-bridge-ref-mode
  (setq lsp-bridge-enable-inlay-hint t)
  (setq lsp-bridge-semantic-tokens-mode t)
  (setq lsp-bridge-ref-open-file-in-request-window t)
  (setq lsp-bridge-ref-kill-temp-buffer-p nil)
  (setq lsp-bridge-ref-delete-other-windows nil)
  (add-to-list 'lsp-bridge-single-lang-server-mode-list '((cuda-mode) . lsp-bridge-c-lsp-server))

  (defun lsp-bridge-ref-open-file (&optional stay quit)
    (interactive)
  ...
  (map! :map lsp-bridge-mode-map
        ...
        :n "C-g" #'lsp-bridge-diagnostic-hide-tooltip
        :i "C-g" #'lsp-bridge-diagnostic-hide-tooltip
        :leader "c r" #'lsp-bridge-rename
        :leader "c a" #'lsp-bridge-code-action
        )

  (map! :map lsp-bridge-ref-mode-map
        :n "C-a" 'lsp-bridge-ref-beginning-of-line
        :n "<tab>" 'lsp-bridge-ref-jump-next-keyword
        :n "<backtab>" 'lsp-bridge-ref-jump-prev-keyword

        :n "j" 'lsp-bridge-ref-jump-next-keyword
        :n "k" 'lsp-bridge-ref-jump-prev-keyword
        :n "h" 'lsp-bridge-ref-jump-next-file
        :n "l" 'lsp-bridge-ref-jump-prev-file
        :n "i" 'lsp-bridge-ref-insert-current-line

        :n "SPC" 'lsp-bridge-ref-open-file
        :n "RET" 'lsp-bridge-ref-open-file-and-stay
        :n "C-m" 'lsp-bridge-ref-open-file-and-stay

        :n "e" 'lsp-bridge-ref-switch-to-edit-mode

        :n "r" 'lsp-bridge-ref-replace-all-matches

        :n "f" 'lsp-bridge-ref-filter-match-results
        :n "F" 'lsp-bridge-ref-filter-mismatch-results

        :n "x" 'lsp-bridge-ref-filter-match-files
        :n "X" 'lsp-bridge-ref-filter-mismatch-files
        :n "u" 'lsp-bridge-ref-unfilter

        :n "D" 'lsp-bridge-ref-remove-line-from-results

        :n "q" 'lsp-bridge-ref-quit)

  (map! :leader "]" #'lsp-bridge-diagnostic-jump-next)
  (map! :leader "[" #'lsp-bridge-diagnostic-jump-prev))
#+END_SRC
