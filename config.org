...
;; (setq fancy-splash-image (concat doom-private-dir "doom.svg"))
...
(setq! doom-font (font-spec :family "Monego" :slant 'normal :weight 'bold :size 22)
       doom-variable-pitch-font (font-spec :family "Monego" :slant 'normal :weight 'bold :size 22)
       doom-big-font (font-spec :family "Monego" :slant 'normal :weight 'bold :size 40))
(setq! doom-unicode-font (font-spec :family "MesloLGS NF" :slant 'normal :weight 'bold))
...
(custom-set-faces!
  ...
  '(lsp-ui-peek-peek :background "#000000")
