...
(setq doom-font (font-spec :family "Consolas" :style "Bold" :size 18)
      doom-variable-pitch-font (font-spec :family "Consolas" :style "Bold" :size 18)
      doom-big-font (font-spec :family "Consolas" :style "Bold" :size 24))

(add-to-list 'default-frame-alist
             '(font . "Consolas-10"))
(set-fontset-font "fontset-default" '(#xf000 . #xf23a) "all-the-icons")

(set-frame-parameter (selected-frame) 'alpha-background 0.90)
...
(use-package! copilot
  ...
  :bind (("M-f" . 'copilot-accept-completion-by-word)
