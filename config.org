...
(setq! doom-font (font-spec :family "Monego" :style "Bold" :size 21)
       doom-variable-pitch-font (font-spec :family "Monego" :style "Bold" :size 21)
       doom-big-font (font-spec :family "Monego" :style "Bold" :size 28))
(setq! doom-unicode-font (font-spec :family "MesloLGS NF" :size 21))
...
(custom-set-faces!
  ...
  ;; '(ivy-minibuffer-match-face-4 :background "#aaabaf" :foreground "#000000")
  ...
  '(org-block-begin-line :background "#000000" )
  '(org-block :background "#000000" )
  '(org-block-end-line :background "#000000" )
  ...
  '(highlight :background "#ffb86c" :foreground "#000000" :inherit bold)
...
(setq
 ...
 `(("\\*Buffer List\\*" display-buffer-in-side-window
   ...
   ("^magit:" display-buffer-in-side-window
    ...
    (preserve-size . (t . nil)) ,parameters)
   ("\\*\\(?:help\\|grep\\|Completions\\|Python\\)\\*\\|^*leetcode\\|^*compilation\\|^*Flutter\\|^*pytest\\|^*docker-build-output\\|^*ein\\|^*MATLAB\\|^* docker container"
